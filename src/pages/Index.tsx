...
const Index = () => {
  return <div className="min-h-screen bg-lime-300 hover:bg-lime-200">
      ...
      {/* Hero Section */}
      <section className="container mx-auto md:py-24 bg-red-100 px-[25px] py-[99px]">
      ...
      {/* Features Section */}
      <section className="py-16 transform-gpu bg-red-100">
        <div className="container mx-auto px-[18px] py-[5px] bg-red-100">
          <h2 className="text-3xl font-bold text-center mb-12 transform transition-all duration-300 hover:scale-105 text-zinc-950">
            Our Features
          </h2>
      ...
      {/* Task Types Section */}
      <section className="container mx-auto px-4 py-16 bg-red-100">
