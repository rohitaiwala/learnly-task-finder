...
const Login = () => {
  ...
  return <div className="min-h-screen bg-[#F1F0FB] dark:bg-[#1A202C]">
      <Navigation />
          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
              ...
              field
                    ...
                    <FormControl>
                      <Input placeholder="Enter your username or email" className="rounded-xl border-gray-200 dark:border-gray-700 focus:border-[#1EAEDB] focus:ring-[#1EAEDB]" {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>} />
              ...
              field
                    ...
                    <FormControl>
                      <div className="relative">
                        <Input type={showPassword ? "text" : "password"} placeholder="Enter your password" className="rounded-xl border-gray-200 dark:border-gray-700 focus:border-[#1EAEDB] focus:ring-[#1EAEDB]" {...field} />
              ...
              <Button type="submit" className="w-full bg-[#1EAEDB] hover:bg-[#1a9bc4] text-white rounded-xl py-2.5">
                Login
              </Button>
            </form>
          </Form>
