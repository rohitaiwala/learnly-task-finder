...
export const Navigation = () => {
  ...
  return <nav className="border-b bg-background/95 backdrop-blur-md shadow-sm">
      <div className="container mx-auto px-4 bg-teal-950 hover:bg-teal-800">
        <div className="flex items-center justify-between px-0 py-0 bg-inherit">
          ...
          <div className="hidden md:flex items-center gap-2">
            <div className="p-1 flex items-center gap-1 rounded-3xl py-[4px] px-[15px] bg-teal-950 hover:bg-teal-800">
